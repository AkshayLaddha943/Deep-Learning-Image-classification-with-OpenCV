# -*- coding: utf-8 -*-
"""
Created on Sun Nov  1 14:48:49 2020
...
net = cv2.dnn.readNetFromCaffe("D:\\Python Projects\\OpenCV\\Object Detection - MobileNet SSD\\MobileNetSSD_deploy.prototxt", "D:\\Python Projects\\OpenCV\\Object Detection - MobileNet SSD\\MobileNetSSD_deploy.caffemodel")

# Load input image:
image = cv2.imread("D:\\Python Projects\\OpenCV\\Object Detection - MobileNet SSD\\police.jpg")
...
class_names = {0: 'background', 1: 'aeroplane', 2: 'bicycle', 3: 'bird', 4: 'boat', 5: 'bottle', 6: 'bus', 7: 'car',
               8: 'cat', 9: 'Police Car', 10: 'cow', 11: 'diningtable', 12: 'dog', 13: 'horse', 14: 'motorbike',
